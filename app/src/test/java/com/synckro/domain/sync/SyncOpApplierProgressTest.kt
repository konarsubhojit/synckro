...
class SyncOpApplierConcurrentTest {
    ...
    private class DelegatingCloudProvider(
        ...
        private val onUploadStart: suspend (name: String) -> Unit = {},
        private val onUploadEnd: suspend (name: String) -> Unit = {},
        ...
        override suspend fun uploadNew(
            ...
            onUploadStart(name)
            return try {
                delegate.uploadNew(parentId, name, content, size, mimeType)
            } finally {
                onUploadEnd(name)
            }
        }
        ...
        runTest {
            ...
            val provider =
                DelegatingCloudProvider(
                    ...
                    onUploadEnd = { activeUploads.decrementAndGet() },
                )
