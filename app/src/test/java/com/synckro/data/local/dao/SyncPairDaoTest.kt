...
class SyncPairDaoTest {
    ...
    @Test
    fun `insert and getById round-trips localTreeUri for internal storage`() =
        runTest {
    ...
    @Test
    fun `insert and getById round-trips localTreeUri for SD card`() =
        runTest {
    ...
    @Test
    fun `upsert overwrites localTreeUri`() =
        runTest {
    ...
    @Test
    fun `insert and getById round-trips avoidMeteredNetworks`() =
        runTest {
            val id = dao.insert(buildEntity("content://test/tree", avoidMeteredNetworks = true))

            val retrieved = dao.getById(id)

            assertNotNull(retrieved)
            assertEquals(true, retrieved!!.avoidMeteredNetworks)
        }
