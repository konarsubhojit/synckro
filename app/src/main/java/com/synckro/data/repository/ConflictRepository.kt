...
class ConflictRepository
    ...
    constructor(
        ...
        suspend fun getResolvedForPair(pairId: Long): List<ConflictRecord> = dao.getResolvedForPair(pairId).map { it.toDomain() }
         ...
         */
        suspend fun insert(record: ConflictRecord): Long = dao.insert(record.toEntity())
        ...
        suspend fun deleteResolvedForPair(pairId: Long) = dao.deleteResolvedForPair(pairId)
    }

private fun ConflictRecordEntity.toDomain(): ConflictRecord =
    ConflictRecord(
        id = id,
        pairId = pairId,
...
private fun ConflictRecord.toEntity(): ConflictRecordEntity =
