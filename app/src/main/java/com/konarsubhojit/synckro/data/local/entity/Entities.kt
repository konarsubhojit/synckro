 ...
 * populated after each successful sync operation by [com.konarsubhojit.synckro.domain.sync.SyncOpApplier].
 * They allow [com.konarsubhojit.synckro.domain.sync.SyncDiffer] to distinguish a genuine
